...
<h1 class="text-4xl">Keyboard Navigation and Semantic HTML</h1>
	...
	<p class="mt-2 "> Notice how if you press your tab key to navigate forward or shift+tab to navigate backward, when navigating to the button it will have a line around it to indicate that it is in a “focus” state.
		...
		<p class=" mt-8">Pressing the “Enter” or “Space” key will trigger the associated action on the element. Try doing that to the button.</p>
	...
	<select class="mt-8  text-neutral-900" onchange={(e) => e.currentTarget.value === "Spongebob" ? alert("I'm ready!") : null} >
		<option>Shrek</option>
...
However, just a div alone would now strip away the accessibility that came with the select element. How do we handle this? That is where we use roles and attributes.
	...
	<ol class="mt-2 flex flex-col gap-2 ">
		...
		<li>
			...
			<p>Specifies whether the dropdown is expanded (true) or collapsed (false). Update this dynamically when the dropdown opens or closes.
			</p>
		</li>
		<li>
		...
		<li>
			...
			<p>Makes the div focusable via keyboard navigation. Users can navigate to it with the Tab key.
			</p>
		</li>
		<li>
			<h4 class="text-green-600">aria-labelledby="select-label"</h4>
			<p>Associates the div with a label ("span" in this case) so screen readers announce what the dropdown represents. The label text is "Choose an option" in this example.
			</p>
		</li>
	</ol>
